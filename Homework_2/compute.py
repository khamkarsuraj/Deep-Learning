...
def main():
    ...
    with open('/Users/suraj/Downloads/MLDS_hw2_1_data 2/i2w.pickle', 'wb') as handle:
        pickle.dump(i2w, handle, protocol = pickle.HIGHEST_PROTOCOL)
    label_file = '/Users/suraj/Downloads/MLDS_hw2_1_data 2/training_data/feat'
    files_dir = '/Users/suraj/Downloads/MLDS_hw2_1_data 2/training_label.json'
    ...
    torch.save(model, "{}/{}.h5".format('/Users/suraj/Downloads/MLDS_hw2_1_data 2/', 'model0'))
